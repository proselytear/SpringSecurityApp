...
<body onload="clickMeth(['buttonObject', 'buttonNotTime', 'defaultbutton', 'defaultbuttonKard'])">
	<div class="full">
		<div class="centered">
			<div class="container">
		...
		<div class="split left">
			...
			<div id="London" class="tabcontent">
				<div id="NotTime" class="tabcontent2">
					<jsp:include page="panelobject.jsp" />
					<jsp:include page="nottime.jsp"></jsp:include>
				</div>
