					...
					<!-- <div id="tabmyModBypass"  class="fieldkard" >
								...
								<c:forEach items="${zoneForAccount}" var="zoneForAccount"	varStatus="status">
									 ...
									 <div id="checkid" class="group">
											...
											${zoneForAccount.getPerifname() }</div>
					...
					<table id="tabmyModBypass">
						...
						<c:forEach items="${zoneForAccount}" var="zoneForAccount" varStatus="status">
							<tr>
								...
								<td id="checkid" class="bg"><input type="radio" name="paramnum" value=${zoneForAccount.getParamnum()} > ${zoneForAccount.getPerifdata()}</td>
							</tr>
						</c:forEach>
					</table>
					<div id="divBypass" class="cent">
						<br />
						<b class="messageRed">${error}</b>
						<b class="messageRed">${messageSuccess}</b>
